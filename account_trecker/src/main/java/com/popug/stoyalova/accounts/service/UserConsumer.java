...
import com.popug.stoyalova.accounts.events.UserChangeRoleEvent;
import com.popug.stoyalova.accounts.events.UserCudEvent;
...
public class UserConsumer {
    ...
    public void consumeCud(final @Payload String message,
        ...
        log.info(String.format("#### -> Consumed CUD user message -> TIMESTAMP: %d %s offset: %d key: %s " +
    ...
    public void consumeBE(final @Payload String message,
        ...
        log.info(String.format("#### -> Consumed BE user message -> TIMESTAMP: %d %s offset: %d " +
